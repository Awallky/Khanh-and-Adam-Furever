document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    en: {
      ...
      hero_subtitle: 'Two chapters, two corners of the world, one love story.',
      badge_ky_chapter: 'Chapter I: The Autumn Gorge',
      badge_ky_date: 'Oct 23, 2027 • Cliffview Resort, KY',
      badge_vn_chapter: 'Chapter II: The Tropical River',
      badge_vn_date: 'Nov 13, 2027 • An Lâm Retreats, VN',
      
      cd_tab_ky: 'Chapter I: Kentucky (Oct 23)',
      cd_tab_vn: 'Chapter II: Vietnam (Nov 13)',
      cd_label_ky: 'Counting down to Chapter I (Cliffview Resort • Oct 23, 2027 at 4:30 PM EDT):',
      cd_label_vn: 'Counting down to Chapter II (An Lâm Retreats • Nov 13, 2027 at 3:00 PM ICT):',
      cd_finished_ky: 'Today is Chapter I Celebration Day in Kentucky!',
      cd_finished_vn: 'Today is Chapter II Celebration Day in Vietnam!',
      cd_days: 'Days',
      cd_hours: 'Hours',
      cd_mins: 'Mins',
      cd_secs: 'Secs',
      ...
      chapters_title: 'Our Two Chapters',
      chapters_intro: 'We are thrilled to celebrate our marriage in two extraordinary settings surrounded by nature and those we love most.',
      dest_ky_tag: 'Chapter I • Kentucky',
      ...
      dest_vn_tag: 'Chapter II • Vietnam',
      ...
      sched_ky_tag: 'Chapter I • Kentucky',
      ...
      sched_vn_tag: 'Chapter II • Vietnam',
    ...
    vi: {
      nav_home: 'Trang Chủ',
      nav_chapters: 'Hai Điểm Hẹn',
      nav_schedule: 'Chương Trình',
      nav_gallery: 'Hình Kỷ Niệm',
      nav_travel: 'Đi Lại & Chỗ Ở',
      nav_rsvp: 'Xác Nhận Tham Dự',
      nav_registry: 'Mừng Cưới',

      hero_tagline: 'Khanh & Adam Furever',
      hero_subtitle: 'Hai buổi tiệc, hai phương trời, chung một câu chuyện tình yêu.',
      badge_ky_chapter: 'Tiệc Kentucky: Thu Vàng Hẻm Núi',
      badge_ky_date: '23/10/2027 • Cliffview Resort, KY',
      badge_vn_chapter: 'Tiệc Sài Gòn: Sông Xanh Nhiệt Đới',
      badge_vn_date: '13/11/2027 • An Lâm Retreats, VN',

      cd_tab_ky: 'Tiệc Kentucky (23/10)',
      cd_tab_vn: 'Tiệc Sài Gòn (13/11)',
      cd_label_ky: 'Cùng đếm ngược đến ngày vui tại Kentucky (Cliffview Resort • 23/10/2027 lúc 16:30):',
      cd_label_vn: 'Cùng đếm ngược đến ngày vui tại Sài Gòn (An Lâm Retreats • 13/11/2027 lúc 15:00):',
      cd_finished_ky: 'Hôm nay là ngày chung vui tại Kentucky!',
      cd_finished_vn: 'Hôm nay là ngày chung vui tại Sài Gòn!',
      cd_days: 'Ngày',
      cd_hours: 'Giờ',
      cd_mins: 'Phút',
      cd_secs: 'Giây',
      ...
      chapters_title: 'Hai Nơi Hội Ngộ Yêu Thương',
      chapters_intro: 'Tụi mình rất hạnh phúc khi được tổ chức ngày trọng đại tại hai không gian thiên nhiên tuyệt đẹp, cùng sự chung vui của gia đình và bạn bè thân thương.',
      dest_ky_tag: 'Tiệc Tại Mỹ • Kentucky',
      dest_ky_date: 'Thứ Bảy, ngày 23 tháng 10 năm 2027 • 16:30 – 20:30',
      dest_ky_place: 'Red River Gorge • Campton, Kentucky',
      dest_ky_desc: 'Tọa lạc giữa những cánh rừng ngút ngàn và vách đá ngoạn mục của Red River Gorge, Cliffview Resort có khung cảnh hữu tình nhìn ra mặt hồ yên ả cùng các căn nhà gỗ (cabin) ấm cúng.',
      dest_ky_btn_web: 'Xem Trang Web Khu Nghỉ Dưỡng ↗',
      dest_ky_btn_map: 'Xem Chỉ Đường Trên Google Maps →',
      dest_vn_tag: 'Tiệc Tại Việt Nam • Sài Gòn',
      dest_vn_date: 'Thứ Bảy, ngày 13 tháng 11 năm 2027 • 15:00 – 22:00',
      dest_vn_place: 'Bên bờ sông Sài Gòn • TP. Hồ Chí Minh',
      dest_vn_desc: 'Nép mình dưới những vòm cây nhiệt đới xanh mát bên dòng sông Sài Gòn êm đềm, An Lâm Retreats kết hợp vẻ đẹp thơ mộng ven sông, cano đưa đón riêng cùng lòng hiếu khách nồng ấm, chu đáo.',
      dest_vn_btn_retreat: 'Khám Phá An Lâm Retreats ↗',
      dest_vn_btn_wedding: 'Thông Tin Tiệc Cưới →',

      sched_title: 'Chương Trình Buổi Lễ',
      sched_intro: 'Thời gian tổ chức lễ cưới và tiệc mừng tại hai nơi:',
      sched_ky_tag: 'Tại Kentucky',
      sched_ky_title: 'Lễ Cưới & Tiệc Mừng',
      sched_ky_time: 'Thứ Bảy, ngày 23 tháng 10 năm 2027<br>16:30 – 20:30 (Giờ EDT)',
      sched_ky_loc: 'Cliffview Resort • Campton, KY',
      sched_ky_link: 'Xem Trang Web Resort →',
      sched_vn_tag: 'Tại Sài Gòn',
      sched_vn_title: 'Lễ Cưới & Tiệc Mừng',
      sched_vn_time: 'Thứ Bảy, ngày 13 tháng 11 năm 2027<br>15:00 – 22:00 (Giờ Việt Nam)',
      sched_vn_loc: 'An Lâm Retreats Sông Sài Gòn • TP. Hồ Chí Minh',
      sched_vn_link: 'Khám Phá An Lâm Retreats →',

      gallery_title: 'Album Kỷ Niệm',
      gallery_intro: 'Những khoảnh khắc đáng nhớ trên hành trình tình yêu của tụi mình. Mọi người có thể xem toàn bộ album hoặc góp thêm hình ảnh kỷ niệm vào album chung nha!',
      gallery_btn: '📷 Xem & Góp Thêm Ảnh Vào Album Google Photos ↗',

      travel_title: 'Thông Tin Đi Lại & Chỗ Ở',
      travel_ky_tag: 'Đi Lại Tại Kentucky',
      travel_ky_title: 'Đường Đến Cliffview Resort',
      travel_ky_airports_title: 'Các sân bay thuận tiện nhất:',
      travel_ky_airport_lex: '<strong>LEX</strong> (Sân bay Blue Grass - Lexington) — khoảng 1 tiếng lái xe',
      travel_ky_airport_cvg: '<strong>CVG</strong> (Sân bay Cincinnati / Northern KY) — khoảng 2 tiếng lái xe',
      travel_ky_airport_sdf: '<strong>SDF</strong> (Sân bay Louisville Muhammad Ali) — khoảng 2 tiếng lái xe',
      travel_ky_stay: '<strong>Chỗ ở:</strong> Có sẵn phòng tại The Lodge và các căn biệt thự gỗ (cabin) riêng tư trong khuôn viên resort.',
      travel_ky_link: 'Xem chỉ đường trên Google Maps →',
      travel_vn_tag: 'Đi Lại Tại Sài Gòn',
      travel_vn_title: 'Đến An Lâm Retreats',
      travel_vn_airports_title: 'Sân bay đến:',
      travel_vn_airport_sgn: '<strong>SGN</strong> (Sân bay Quốc tế Tân Sơn Nhất, TP. Hồ Chí Minh)',
      travel_vn_transfer: '<strong>Phương tiện di chuyển:</strong> Chi tiết cano / xe đưa đón tụi mình sẽ cập nhật sau (TBD).',
      travel_vn_visa: '<strong>Hộ chiếu & Thị thực:</strong> Bạn bè từ nước ngoài nhớ kiểm tra hộ chiếu còn hạn ít nhất 6 tháng và xin e-Visa Việt Nam trước chuyến đi nhé.',

      rsvp_title: 'Xác Nhận Tham Dự (RSVP)',
      rsvp_subtext: 'Dù chung vui cùng tụi mình tại Kentucky, Sài Gòn hay cả hai nơi, xin vui lòng gửi phản hồi trước các mốc thời gian dưới đây nha.',
      rsvp_ky_deadline: '<strong>Cliffview Resort (KY):</strong> Xin xác nhận trước ngày 15/08/2027',
      rsvp_vn_deadline: '<strong>An Lâm Retreats (VN):</strong> Xin xác nhận trước ngày 15/08/2027',
      rsvp_update_note: 'Nếu cần thay đổi thông tin sau khi gửi, bạn có thể điền lại biểu mẫu này hoặc dùng đường dẫn chỉnh sửa trong email xác nhận.',
      rsvp_direct_link: 'Gặp khó khăn khi điền biểu mẫu? Mở RSVP trong tab mới →',

      registry_title: 'Mừng Cưới',
      registry_subtext: 'Sự hiện diện và lời chúc phúc của mọi người là món quà quý giá nhất dành cho tụi mình rồi. Thông tin về quà mừng cưới sẽ được tụi mình cập nhật sau (TBD).',

      footer_text: 'Tụi mình rất mong được đón tiếp và chung vui cùng mọi người!',
